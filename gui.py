...
from customtkinter import CTkProgressBar,CTkScrollbar,set_default_color_theme
import webbrowser
...
ASSETS_PATH = OUTPUT_PATH / Path("/".join([path_2, "assets"]))
...
set_default_color_theme(relative_to_assets('theme.json'))
